...
import { handleAddToCart } from "@/helpers/cart/addToCart";
...
export default function Products() {
  ...
  useEffect(() => {
    ...
    // fetchProducts(1); // Fetch initial products on mount, starting at page 1
    // window.scroll(0, 0);
  ...
  // useEffect(() => {
  //   window.scroll(0, 0);
  //   fetchProducts(1); // Reset to page 1 when showValue changes
  // }, [showValue]);
